 ...
 describe('BinarySearchTree', () => {
  ...
  describe('delete', () => {
    ...
    it('should delete a left leaf node which its value is 20 correctly', () => {
      ...
      BST.delete(20)
      expect(BST.left.left).toBeFalsy()
    })
    
    it('should delete a node which its value is 80 and it has 1 right sub node correctly', () => {
      expect(BST.right.right.value).toBe(80)
      expect(BST.right.right.right.value).toBe(90)
      BST.delete(80)
      expect(BST.right.right.value).toBe(90)
      expect(BST.right.right.right).toBeFalsy()
    })

    it('should delete a node correctly which its value is 70 and it have 2 children and nodeToRemove doesnt have left subtree', () => {
      expect(BST.right.value).toBe(70)
      BST.delete(70)
      expect(BST.right.value).toBe(80)
    })
